...
const Home = () => {
    return (
        <div className='p-8'>
            <h1 className='text-center md:text-left text-3xl text-ckdGreen font-bold'>About The Practice</h1>
            <div className='mt-8 space-y-4'>
                ...
                <div className='flex flex-col items-center justify-center'>
                    <ul className='text-left space-y-2 text-ckdGreen'>
                        ...
                        <li className='list-disc'><p className='text-black'>You may be asked to give a urine specimen at your visit</p></li>
                        ...
                        <li className='list-disc'><p className='text-black'>Please download and fill out the <b>New Patient Forms Package</b> and <b>bring</b> them to your visit</p></li>
            ...
            <p className='text-left text-lg mt-8'>If you must change your appointment date or time, kindly give us at least <b>24 hours notice</b> so that we may accommodate you and other patients who need an appointment.  You may be charged for missed appointments.</p>
            ...
            <div className='border border-t-ckdGreen my-10'></div>
            <img className='w-[200px]' alt='Dr. Lazar' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQrsR4wBqoQ8-j6OTdUka8b_9uql_1RdmAjOQ&s" />
            <p className='text-left text-lg mt-8'>Dr Andrew E. Lazar has a degree in Biomedical Engineering from Boston University.  He worked as a design engineer at General Motors before returning to medical school at Wayne State University in Detroit, MI.  He studied Internal Medicine at the University of Virginia where he was chosen as a chief resident.  Later he studied Nephrology at Case Western Reserve University.  He is the clinical trials director for the UH Case Medical Center department of nephrology with a particular interest in lupus, IgA nephropathy, and genetic disorders. He is a consulting medical director for Natera, a kidney genetics company. He established Cleveland Home Dialysis, and consults with Embassy Healthcare in the development of a kidney-focused care management program in an effort to improve outcomes for nursing home patients with CKD, diabetes, and heart failure and to lower return-to-hospital rates.</p>
            <div className='border border-t-ckdGreen my-10'></div>
