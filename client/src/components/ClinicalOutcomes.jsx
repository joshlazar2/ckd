    ...
    return (
        <div>
            ...
            <div className='flex justify-center'>
                <iframe title="Clinical Outcomes CKD" src="https://qxmd.com/calculate/calculator_621/clinical-outcomes-in-ckd-with-severely-decreased-gfr?embed=1" width="80%" height="800" id="qxmd_calculate" frameborder="0" scrolling="yes"></iframe>
            </div>
        </div>
        </div>
    );
