    ...
    return (
        <div className='p-8'>
            ...
            <div className='text-left space-y-16'>
                ...
                <div>
                    <Link to={'/riskCalculators/DialysisRiskAfterCardiacSurgeryClevelandClinic'}><p className='text-2xl text-ckdGreen'>Dialysis Risk After Cardiac Surgery <br /> (Cleveland Clinic Score by Thakar)</p></Link>
                </div>
                <div>
